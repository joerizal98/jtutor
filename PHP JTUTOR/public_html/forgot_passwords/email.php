...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #6f42c1; height: 100%; margin: 0; padding: 0; width: 100%">
 <br><br><br>
  <center>
 ...
 100%; background-color: #6f42c1; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #6f42c1;
 ...
 padding-bottom: 9px; padding-left: 18px;" valign="top">
                                <a href="https://www.jtutor.ml" style="mso-line-height-rule: exactly;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="">
                                  <img align="none" alt="" height="40" src="https://www.jtutor.ml/img/nest.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 130px; height: 40px; margin: 0px;" width="107" />
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="https://www.jtutor.ml" style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #6f42c1; font-weight: normal; text-decoration: none" target="_blank" title="">
                                  <a class="" href="https://www.jtutor.ml/" style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #6f42c1; font-weight: normal; text-decoration: none" target="_blank" title="">
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="https://www.jtutor.ml/reset_password?hash='.$hash.'" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: #6f42c1;
 ...
 text-align: left; text-align: left; font-size: 14px;">JTutor is an online tuition platform for student under 7 year to 17 year old. Build to help student who cannot afford a tuisyen class and come with nice platform.
                              </p>
                              <div style="padding-bottom: 18px;">
                                <a href="https://www.jtutor.ml" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #6f42c1; font-weight: normal; text-decoration: none;
 font-size: 14px; color:#6f42c1; text-decoration:none;" target="_blank" title="Learn more about JTutor">Learn More ❯</a>
                              </div>
                            </td>
                          </tr>
                        </table>
 ...
 font-weight: normal; text-decoration: none; color:white;" target="_blank" title="Noun Project - Icons for Everything">Noun Project</a>in Culver City, CA 90232</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
 ...
 text-decoration: none" width="32" />
          ...
          <!-- // END TEMPLATE -->
            ...
            if (PEAR::isError($mail)) {
                ...
                header("location: https://www.jtutor.ml/forgot_passwords/?alert=success");
            }
?>