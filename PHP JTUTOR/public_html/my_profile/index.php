        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown">
                            <img src="https://www.jtutor.ml/user_avatar/<?php echo $avatar;?>" alt="Avatar" class="avatar"> <?php echo strtoupper($_SESSION["name"]); }?> <b class="caret"></b>
                        </a>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="../my_profile" class="active"><i class="fas fa-user fa-fw"></i> My Profile</a>
                            </li>
                            <?php if(strtolower($_SESSION['User']) == "admin"){
                        ...
                        <div class="">
                            <div class="">
                                <div class="row" style="position: relative; height: 1700px">
                                	<!--start here-->
                            		<iframe name="my_frame" src="prof.php" style=" height: 100%; width:100%;" frameborder="0" scrolling="no"></iframe>
                                    <!--end here-->
                                    <!-- /.col-lg-4 (nested) -->
                                    <div class="col-lg-8">
                                    </div>
