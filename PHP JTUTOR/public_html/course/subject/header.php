...
<head>
    ...
    <link rel="stylesheet" href="footer/bootstrap-4.1.0-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="footer/css/fixed.css">
    <link rel="stylesheet" href="footer/css/lightbox.css">
    <style>
		#btn{
			color: white;
		}
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" class="" href="../" target="_parent">Course</a>
                        </li>
                        <?php
						    ...
						    if(isset($_SESSION['User']))
						    {
						        ...
						        '<div class="dropdown">
						        <li class="nav-item">
									<a class="nav-link" id="btn">'.$_SESSION['name'].'</a>
