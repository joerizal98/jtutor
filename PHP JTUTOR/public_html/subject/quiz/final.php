...
<body>
	<div class="logo">
	    <div style="padding-top: 26%; padding-left:50%">
    		<div>
		...
		<div style="padding-top:4%; padding-right:3%; float:right; font-size:14px;">
		<button class="button button1" onclick="location.href = 'https://www.jtutor.ml/subject/?id=<?echo $_GET['id'];?>';"><b>Finish</b></button>
	    <button class="button button1" onclick="location.href = 'https://www.jtutor.ml/subject/quiz/?id=<?echo $_GET['id'];?>&name=<?echo $_GET['name'];?>';"><b>Close</b></button>
	    </div>
	</div>
