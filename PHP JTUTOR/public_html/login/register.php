<?php
    ...
    {
        header("location: http://localhost/jtutor/");
    }
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" class="" href="../index.php">Home</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" class="" href="../index.php#howitwork">How It Works</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" class="" href="../index.php#aboutus">About Us</a>
						</li>
						<li class="nav-item">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="process.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@example.com" >
						<input class="input100" type="text" name="user" placeholder="Full Name" required>
					...
					<div class="container-login100-form-btn">
						<input class="login100-form-btn" type="submit" value="Register Now" name="Login">
					</div>
