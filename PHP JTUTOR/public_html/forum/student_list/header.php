...
<head>
    ...
    <link rel="stylesheet" href="https://www.jtutor.ml/style.css">
    <link rel="stylesheet" href="https://www.jtutor.ml/bootstrap-4.1.0-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://www.jtutor.ml/css/fixed.css">
    <link rel="stylesheet" href="https://www.jtutor.ml/css/lightbox.css">
    <style>
		#btn{
			color: white;
		}
...
<div id="home">
        ...
        <nav class="navbar navbar-expand-md fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="https://www.jtutor.ml/" target="_parent"><img src="https://www.jtutor.ml/img/nest.png"  alt="JTutor"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" class="" href="https://www.jtutor.ml/#howitwork" target="_parent">How It Works</a>
                        </li>
                        <li class="nav-item">
						    ...
						    if(isset($_SESSION['User']))
						    {
						        ...
						        <li class="nav-item">
									...
									<div class="dropdown-content">
									    ...
									    <a href="https://www.jtutor.ml/logout/?logout" target="_parent">Logout</a>
  									</div>
								</li></div>';
